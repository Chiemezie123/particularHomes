...
import { CloseXIcon } from "@/assets/svg";
        ...
        <div className="fixed inset-0 z-[100] flex w-full items-center justify-center overflow-y-auto hideScrollBar">
          ...
          >
            ...
            >
              {/* Modal Header */}
              {title && (
                <div className="sticky top-0 flex items-center justify-between rounded-t-[inherit] border border-solid border-red-500 bg-N0 px-6 py-4">
                  <Typography variant="p-l" color="black">
                    {title}
                  </Typography>

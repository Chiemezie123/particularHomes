...
export default function SideBar() {
  return (
    <div className="flex flex-col items-start gap-8 w-[280px] p-4 border-r border-[#D3DBDA] bg-[#FBFFFF] h-screen">
      <div className="px-2">
        <Typography customClassName="text-[var(--Paircular-Variant,#003D36)] font-sf-pro text-[28px] font-semibold leading-none tracking-[-0.56px]">Paircular Holmes</Typography>
      </div>
